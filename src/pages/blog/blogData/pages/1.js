...
export default function one() {
  ...
  <motion.div initial={{opacity:0, y:2}} animate={{opacity:1, y:0}} transition={{duration:0.5}}>
    ...
    <Col span={12} id='blogText'>
      <p id='sectionTitle'>Tax as a methodology for doing good</p>
      ...
      <p id='subSectionTitle'>Goverment Incompetence</p>
      ...
      <p id='subSectionTitle'>Inhibit illegal financial flows</p>
      ...
      <p id='subSectionTitle'>Taxation as a Force for Good</p>
      ...
      <p id='subSectionTitle'>Moving Forward</p>
