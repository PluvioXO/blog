...
export default function one() {
  ...
  const sections = [
    ...
    },
    {
      ...
      title: 'Government Incompetence',
    },
    {
      id: 'illegal-financial-flows',
      title: 'Inhibit Illegal Financial Flows',
    },
    {
  ...
  <motion.div className="blog-post-container" initial={{opacity:0, y:2}} animate={{opacity:1, y:0}} transition={{duration:0.5}}>
    <Row justify="center">
      ...
      <Col xs={22} sm={14} md={12} lg={10} xl={10} className='blog-text-content'>
        <p id="introduction" className='section-title'>Tax as a methodology for doing good</p>
        ...
        <p id="government-incompetence" className='subsection-title'>Goverment Incompetence</p>
        ...
        <p id="illegal-financial-flows" className='subsection-title'>Inhibit illegal financial flows</p>
        ...
        <p id="taxation-force-good" className='subsection-title'>Taxation as a Force for Good</p>
        ...
        <p id="moving-forward" className='subsection-title'>Moving Forward</p>
