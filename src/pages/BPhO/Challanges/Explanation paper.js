...
export default function ExplanationPaper() {
  ...
  return(
      ...
      <center>
        ...
        margin: "auto",
        height: "min-content"}}>
      <div style={{width:'min-content', borderStyle:'solid', borderWidth:'thin', borderColor:'grey'}}>
      <Document file={pdfFile}  onLoadSuccess={onDocumentLoadSuccess}>
        ...
        <Row>
          ...
          <Col span={6}><Button onClick={pageRight} disabled={r} style={{borderBottomRightRadius:'10px', borderTopRightRadius: '10px'}}>→</Button></Col>
            ...
            <Page pageNumber={x} renderTextLayer={false} renderAnnotationLayer={false} style={{height:'200px'}}/>
      </Document>
      </div>
      </div>
      </center>  
